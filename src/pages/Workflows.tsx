...
import { useWorkflowsLogic } from '../features/workflows/hooks/useWorkflowsLogic';

export const Workflows = React.memo(function Workflows() {
  const {
    workflows,
    selectedWorkflow,
    setSelectedWorkflow,
  ...
  }, [workflows, setSelectedWorkflow, getStatusIcon]);
